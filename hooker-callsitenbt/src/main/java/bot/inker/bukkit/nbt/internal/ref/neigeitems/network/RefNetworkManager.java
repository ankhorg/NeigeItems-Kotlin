...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NetworkManager", predicates = "craftbukkit_version:[v1_12_R1,)")
public class RefNetworkManager extends SimpleChannelInboundHandler<RefPacket<?>> {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NetworkManager;channel:Lio/netty/channel/Channel;", predicates = "craftbukkit_version:[v1_12_R1,)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NetworkManager;channelRead0(Lio/netty/channel/ChannelHandlerContext;Lnet/minecraft/server/v1_12_R1/Packet;)V", predicates = "craftbukkit_version:[v1_12_R1,)")
