...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/EnumInteractionResult", predicates = "craftbukkit_version:[v1_12_R1,)")
public final class RefEnumInteractionResult {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/EnumInteractionResult;SUCCESS:Lnet/minecraft/server/v1_12_R1/EnumInteractionResult;", predicates = "craftbukkit_version:[v1_12_R1,)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_15_R1/EnumInteractionResult;CONSUME:Lnet/minecraft/server/v1_15_R1/EnumInteractionResult;", predicates = "craftbukkit_version:[v1_15_R1,)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/EnumInteractionResult;PASS:Lnet/minecraft/server/v1_12_R1/EnumInteractionResult;", predicates = "craftbukkit_version:[v1_12_R1,)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/EnumInteractionResult;FAIL:Lnet/minecraft/server/v1_12_R1/EnumInteractionResult;", predicates = "craftbukkit_version:[v1_12_R1,)")
