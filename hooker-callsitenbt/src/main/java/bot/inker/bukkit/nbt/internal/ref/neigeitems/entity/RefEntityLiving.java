...
public abstract class RefEntityLiving extends RefEntity {
    ...
    @HandleBy(version = CbVersion.v1_13_R1, reference = "Lnet/minecraft/server/v1_13_R2/EntityLiving;aQ:F")
    ...
    @HandleBy(version = CbVersion.v1_13_R1, reference = "Lnet/minecraft/server/v1_13_R2/EntityLiving;aR:F")
    ...
    @HandleBy(version = CbVersion.v1_13_R1, reference = "Lnet/minecraft/server/v1_13_R2/EntityLiving;aS:F")
    ...
    @HandleBy(version = CbVersion.v1_13_R1, reference = "Lnet/minecraft/server/v1_13_R2/EntityLiving;aT:F")
