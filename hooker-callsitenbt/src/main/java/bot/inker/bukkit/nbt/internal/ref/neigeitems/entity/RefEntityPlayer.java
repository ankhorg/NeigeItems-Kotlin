...
import pers.neige.neigeitems.internal.ref.block.sign.RefSignBlockEntity;
import pers.neige.neigeitems.internal.ref.network.RefPlayerConnection;
...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/EntityPlayer", predicates = "craftbukkit_version:[v1_12_R1,)")
public final class RefEntityPlayer extends RefEntityHuman {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/EntityPlayer;playerInteractManager:Lnet/minecraft/server/v1_12_R1/PlayerInteractManager;", predicates = "craftbukkit_version:[v1_12_R1,)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/EntityPlayer;playerConnection:Lnet/minecraft/server/v1_12_R1/PlayerConnection;", predicates = "craftbukkit_version:[v1_12_R1,)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/EntityPlayer;openSign(Lnet/minecraft/server/v1_12_R1/TileEntitySign;)V", predicates = "craftbukkit_version:[v1_12_R1,)")
