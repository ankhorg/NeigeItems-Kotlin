...
public class RefEntitySheep extends RefEntity {
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_14_R1/EntitySheep;<init>(Lnet/minecraft/server/v1_14_R1/EntityTypes;Lnet/minecraft/server/v1_14_R1/World;)V", predicates = "craftbukkit_version:[v1_14_R1,)")
  public RefEntitySheep(RefNewEntityTypes<? extends RefEntitySheep> type, RefWorld world) {
    throw new UnsupportedOperationException();
  }

  @HandleBy(reference = "Lnet/minecraft/world/entity/animal/Sheep;registerGoals()V", predicates = "craftbukkit_version:[v1_17_R1,)")
  @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/EntitySheep;r()V", predicates = "craftbukkit_version:[v1_12_R1,)")
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/EntitySheep;M()V", predicates = "craftbukkit_version:[v1_12_R1,)")
