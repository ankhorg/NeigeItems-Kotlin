...
import pers.neige.neigeitems.item.lore.impl.*;
...
public interface Text {
    ...
    @NotNull
    default <T, R extends List<T>> R getText(@NotNull R result, @NotNull BaseActionManager manager, @NotNull ActionContext context, Function<String, T> converter) {
        return result;
    }
