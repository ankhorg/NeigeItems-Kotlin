...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/Blocks", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
public final class RefBlocks {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/Blocks;ANVIL:Lnet/minecraft/server/v1_12_R1/Block;", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/Blocks;ENCHANTING_TABLE:Lnet/minecraft/server/v1_12_R1/Block;", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
