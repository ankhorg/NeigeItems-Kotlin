...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/BlockPosition", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
public final class RefBlockPos {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/BlockPosition;ZERO:Lnet/minecraft/server/v1_12_R1/BlockPosition;", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/BlockPosition;<init>(III)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
