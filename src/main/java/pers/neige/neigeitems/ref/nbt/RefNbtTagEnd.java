...
public final class RefNbtTagEnd extends RefNbtBase {
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_16_R3/NBTTagEnd;b:Lnet/minecraft/server/v1_16_R3/NBTTagEnd;", predicates = "craftbukkit_version:[v1_15_R1,v1_17_R1)")
