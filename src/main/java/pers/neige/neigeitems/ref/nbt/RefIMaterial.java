...
@HandleBy(reference = "net/minecraft/server/v1_13_R2/IMaterial", predicates = "craftbukkit_version:[v1_13_R1,v1_17_R1)")
public final class RefIMaterial {
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_16_R3/IMaterial;getItem()Lnet/minecraft/server/v1_16_R3/Item;", isInterface = true, predicates = "craftbukkit_version:[v1_13_R1,v1_17_R1)")
