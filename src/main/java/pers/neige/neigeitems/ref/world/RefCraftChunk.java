...
public final class RefCraftChunk {
    ...
    @HandleBy(reference = "Lorg/bukkit/craftbukkit/v1_12_R1/CraftChunk;<init>(Lnet/minecraft/server/v1_12_R1/Chunk;)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
