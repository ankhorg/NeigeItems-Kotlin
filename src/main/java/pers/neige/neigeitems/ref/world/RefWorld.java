...
public abstract class RefWorld {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/World;spigotConfig:Lorg/spigotmc/SpigotWorldConfig;", predicates = "craftbukkit_version:[v1_12_R1,)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_13_R1/World;getEntities(Lnet/minecraft/server/v1_13_R1/Entity;Lnet/minecraft/server/v1_13_R1/AxisAlignedBB;Ljava/util/function/Predicate;)Ljava/util/List;", predicates = "craftbukkit_version:[v1_13_R1,)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/World;getChunkIfLoaded(II)Lnet/minecraft/server/v1_12_R1/Chunk;", predicates = "craftbukkit_version:[v1_12_R1,)")
