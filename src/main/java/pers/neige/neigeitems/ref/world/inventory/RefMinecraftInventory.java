...
public class RefMinecraftInventory implements RefContainer {
    ...
    @HandleBy(reference = "Lorg/bukkit/craftbukkit/v1_17_R1/inventory/CraftInventoryCustom$MinecraftInventory;adventure$title:L;", predicates = "craftbukkit_version:[v1_16_R1,)", useAccessor = true)
