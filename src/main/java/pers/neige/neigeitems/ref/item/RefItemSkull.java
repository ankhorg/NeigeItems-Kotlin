...
@HandleBy(reference = "net/minecraft/server/v1_13_R1/ItemSkullPlayer", predicates = "craftbukkit_version:[v1_13_R1,v1_17_R1)")
@HandleBy(reference = "net/minecraft/server/v1_12_R1/ItemSkull", predicates = "craftbukkit_version:[v1_12_R1,v1_13_R1)")
