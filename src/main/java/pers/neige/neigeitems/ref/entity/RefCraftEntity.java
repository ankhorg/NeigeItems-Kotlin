...
public abstract class RefCraftEntity {
    ...
    @HandleBy(reference = "Lorg/bukkit/craftbukkit/v1_12_R1/entity/CraftEntity;getHandle()Lnet/minecraft/server/v1_12_R1/Entity;", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
