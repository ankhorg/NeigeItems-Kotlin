...
public class RefCraftLivingEntity extends RefCraftEntity {
    ...
    @HandleBy(reference = "Lorg/bukkit/craftbukkit/v1_12_R1/entity/CraftLivingEntity;getHandle()Lnet/minecraft/server/v1_12_R1/EntityLiving;", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
