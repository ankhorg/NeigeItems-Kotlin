...
public final class RefCraftItem extends RefCraftEntity {
    ...
    @HandleBy(reference = "Lorg/bukkit/craftbukkit/v1_12_R1/entity/CraftItem;item:Lnet/minecraft/server/v1_12_R1/EntityItem;", useAccessor = true, predicates = "craftbukkit_version:[v1_12_R1,)")
