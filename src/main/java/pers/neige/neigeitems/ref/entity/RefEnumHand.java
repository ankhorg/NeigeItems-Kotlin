...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/EnumHand", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
public final class RefEnumHand {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/EnumHand;MAIN_HAND:Lnet/minecraft/server/v1_12_R1/EnumHand;", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/EnumHand;OFF_HAND:Lnet/minecraft/server/v1_12_R1/EnumHand;", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
