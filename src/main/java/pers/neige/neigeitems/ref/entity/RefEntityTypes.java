...
public final class RefEntityTypes {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/EntityTypes;a(Lnet/minecraft/server/v1_12_R1/Entity;)Lnet/minecraft/server/v1_12_R1/MinecraftKey;", predicates = "craftbukkit_version:[v1_12_R1,v1_13_R1)")
    public static native RefMinecraftKey getMinecraftKey(RefEntity entity);
