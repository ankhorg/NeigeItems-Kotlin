...
public final class RefPacketPlayOutLookAt implements RefPacket<RefPacketListenerPlayOut> {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_13_R1/PacketPlayOutLookAt;<init>(Lnet/minecraft/server/v1_13_R1/ArgumentAnchor$Anchor;DDD)V", predicates = "craftbukkit_version:[v1_13_R1,v1_17_R1)")
