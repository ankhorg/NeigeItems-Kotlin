...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/PacketPlayOutAnimation", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
public final class RefPacketPlayOutAnimation implements RefPacket<RefPacketListenerPlayOut> {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/PacketPlayOutAnimation;<init>(Lnet/minecraft/server/v1_12_R1/Entity;I)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
