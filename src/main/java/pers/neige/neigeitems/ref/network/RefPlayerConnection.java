...
public final class RefPlayerConnection {
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/PlayerConnection;teleportAwait:I", useAccessor = true, predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/PlayerConnection;sendPacket(Lnet/minecraft/server/v1_12_R1/Packet;)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/PlayerConnection;a(Lnet/minecraft/server/v1_12_R1/PacketPlayInFlying;)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
    ...
    @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/PlayerConnection;internalTeleport(DDDFFLjava/util/Set;)V", predicates = "craftbukkit_version:[v1_12_R1,v1_17_R1)")
