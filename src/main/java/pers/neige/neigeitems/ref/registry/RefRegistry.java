...
public interface RefRegistry<T> {
    @HandleBy(reference = "Lnet/minecraft/core/Registry;getKey(Ljava/lang/Object;)Lnet/minecraft/resources/ResourceLocation;", isInterface = true, predicates = "craftbukkit_version:[v1_17_R1,)")
