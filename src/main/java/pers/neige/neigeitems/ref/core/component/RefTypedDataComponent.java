...
public final class RefTypedDataComponent<T> {
    @HandleBy(reference = "Lnet/minecraft/core/component/TypedDataComponent;<init>(Lnet/minecraft/core/component/DataComponentType;Ljava/lang/Object;)V", predicates = "craftbukkit_version:[v1_20_R4,)")
    public RefTypedDataComponent(RefDataComponentType<T> type, T value) {
    ...
    @HandleBy(reference = "Lnet/minecraft/core/component/TypedDataComponent;applyTo(Lnet/minecraft/core/component/PatchedDataComponentMap;)V", predicates = "craftbukkit_version:[v1_20_R4,)")
    public native void applyTo(RefPatchedDataComponentMap components);
