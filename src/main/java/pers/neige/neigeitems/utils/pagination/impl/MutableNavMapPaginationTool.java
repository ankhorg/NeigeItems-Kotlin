...
public class MutableNavMapPaginationTool<K, V> extends PaginationTool<Entry<K, V>> {
    /**
     * 可变数据
     */
    ...
    public MutableNavMapPaginationTool(@NotNull NavigableMap<K, V> set, int pageSize) {
        super(pageSize);
        this.handle = set;
