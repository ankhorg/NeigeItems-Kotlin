...
public class ConditionStringEvaluator extends ConditionEvaluator<String> {
    public ConditionStringEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
