...
public class DoubleTreeBooleanEvaluator extends DoubleTreeEvaluator<Boolean> {
    public DoubleTreeBooleanEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
