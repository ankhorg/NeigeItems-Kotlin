...
public class WeightDoubleEvaluator extends WeightEvaluator<Double> {
    public WeightDoubleEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
