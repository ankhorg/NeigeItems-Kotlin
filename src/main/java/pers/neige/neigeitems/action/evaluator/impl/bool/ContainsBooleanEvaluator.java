...
public class ContainsBooleanEvaluator extends ContainsEvaluator<Boolean> {
    public ContainsBooleanEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
