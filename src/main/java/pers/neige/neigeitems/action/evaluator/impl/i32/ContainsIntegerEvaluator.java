...
public class ContainsIntegerEvaluator extends ContainsEvaluator<Integer> {
    public ContainsIntegerEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
