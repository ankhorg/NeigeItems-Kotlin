...
public class ContainsLongEvaluator extends ContainsEvaluator<Long> {
    public ContainsLongEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
