...
public class ConditionLongEvaluator extends ConditionEvaluator<Long> {
    public ConditionLongEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
