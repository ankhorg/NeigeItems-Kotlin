...
public class IntTreeBooleanEvaluator extends IntTreeEvaluator<Boolean> {
    public IntTreeBooleanEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
