...
public class ConditionWeightLongEvaluator extends ConditionWeightEvaluator<Long> {
    public ConditionWeightLongEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
