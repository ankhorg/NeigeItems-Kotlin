...
public class DoubleTreeStringEvaluator extends DoubleTreeEvaluator<String> {
    public DoubleTreeStringEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
