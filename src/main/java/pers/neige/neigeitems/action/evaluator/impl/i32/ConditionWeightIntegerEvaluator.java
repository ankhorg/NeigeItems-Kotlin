...
public class ConditionWeightIntegerEvaluator extends ConditionWeightEvaluator<Integer> {
    public ConditionWeightIntegerEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
