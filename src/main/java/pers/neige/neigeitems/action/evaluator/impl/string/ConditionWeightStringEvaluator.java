...
public class ConditionWeightStringEvaluator extends ConditionWeightEvaluator<String> {
    public ConditionWeightStringEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
