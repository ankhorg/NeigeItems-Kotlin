...
public class ConditionWeightDoubleEvaluator extends ConditionWeightEvaluator<Double> {
    public ConditionWeightDoubleEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
