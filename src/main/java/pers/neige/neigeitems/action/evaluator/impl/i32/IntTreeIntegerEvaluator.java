...
public class IntTreeIntegerEvaluator extends IntTreeEvaluator<Integer> {
    public IntTreeIntegerEvaluator(@NonNull BaseActionManager manager, @NonNull ConfigReader config) {
