...
public interface NbtComponentLike extends NbtLike, Map<String, Nbt<?>> {
    ...
    default Nbt<?> removeDeep(@NotNull String key) {
        ...
        bot.inker.bukkit.nbt.api.NbtComponentLike currentNbtCompound = this;
        for (int i = 0; i < (keys.length - 1); i++) {
            ...
            if (currentNbtCompound.containsKey(k)) {
                ...
                if (obj instanceof bot.inker.bukkit.nbt.api.NbtComponentLike) {
                    currentNbtCompound = (bot.inker.bukkit.nbt.api.NbtComponentLike) obj;
                } else {
    ...
    bot.inker.bukkit.nbt.api.NbtComponentLike clone();
}
