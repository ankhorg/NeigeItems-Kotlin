...
NbtItemStack {
  ...
  @Override
  public bot.inker.bukkit.nbt.NbtItemStack clone() throws CloneNotSupportedException {
    return new bot.inker.bukkit.nbt.NbtItemStack(NbtUtils.asCopy(itemStack));
  }
}
