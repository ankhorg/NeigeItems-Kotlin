...
/**
 * 1.21.11+ 版本, Identifier 特殊兼容
 */
public class NMSHookerIdentifier extends NMSHookerItemStack {
    @Override
    ...
    public Object getDataComponentType(String key) {
        return BuiltInRegistries.DATA_COMPONENT_TYPE.getValue(Identifier.parse(key));
    }
